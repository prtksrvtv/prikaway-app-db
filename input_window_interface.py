...
def rty(d):
    ...
    if d['House'].lower()=='a':
        d['House']='Arjan'
    elif d['House'].lower()=='c':
        d['House']='Cariappa'
    elif d['House'].lower()=='k':
        d['House']='Katari'
    elif d['House'].lower()=='m':
        d['House']='Manekshaw'
    elif d['House'].lower()=='p':
        d['House']='Pereira'
    elif d['House'].lower()=='s':
        d['House']='Subroto'
    elif d['House'].lower()=='r':
        d['House']='Rezangla'
    else:
    ...
    try:
        for x in d:
            if x not in ['Roll No.','Name','Class','House','Date']:
                if type(int(d[x][0])) is int:
                    continue
            elif x== 'Roll No.':
                if type(int(d[x])) is int:
                    continue
