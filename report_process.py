...
def invoice_processing(a,root):
    ...
    if os.path.exists(path+'Covers.pdf'):
        os.remove(path+'Covers.pdf')
    if os.path.exists(path+'Invoices.pdf'):
        os.remove(path+'Invoices.pdf')    
    os.rename(os.getcwd()+'\Covers.pdf' , path+'Covers.pdf')
    os.rename(os.getcwd()+'\Invoices.pdf' , path+'Invoices.pdf')
    yalla(root)
